...
# Copy the singleton factory to safe-smart-contracts directory named `singleton-factory-deployments`
mkdir -p /app/prereq/safe-smart-contracts/singleton-factory-deployments
cp -r $SINGLETON_FACTORY /app/prereq/safe-smart-contracts/singleton-factory-deployments
ls /app/prereq/safe-smart-contracts/singleton-factory-deployments
